                    ...
                    <div class="single-event mb-35">
                        ...
                        <div class="event-content text-start">
                            <div class="event-content-left">
                                ...
                                <ul>
                                    <li><?php echo $row->detaha; ?></li>
                                </ul>
                            </div>
                            <div class="event-content-right">
                                <?php
                                    if ($row->estadha == 1) {
                                        echo '<a href="/formularioAgendar.php?id=' . $row->idhab . '" class="default-btn">Agendar</a>';
                                        // code...
                                    } else if ($row->estadha == 2) {
                                        //echo '<button class="btn btn-white btn-lg">Ocupado</button>';
                                        echo '<a href="#" class="default-btn">No disponible</a>';
                                    } else {
                                        echo '<a href="#" class="default-btn">En curso</a>';
