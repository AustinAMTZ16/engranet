            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <img src="img/icon/cita.png" alt="section-title">
                        <h2>Agenda tu asesoria gratis</h2>
                    </div>
                </div>
            </div>
            <?php
					require './config/ConexionSNSesion.php';
					$id = $_GET['id'];
                ...
                Folio cita:<?php echo $d->numiha; ?>
                    <form class="formInteresado"  action="registroagenda.php" method="POST">
                        <div class="row">
                            <div class="col-md-12">
                                <p>Nombre completo</p>
                                <input type="text" name="mdnom">
                                <input type="text" name="mdap" value="NA" hidden>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <p>Telefono</p>
                                <input type="text" name="mdnum">
                                <p>Mensaje</p>
                                <textarea name="rxobs" cols="15" rows="10"></textarea>
                            </div>

                            <input type="text" hidden class="form-control" name="rxent" value="<?php $fechaActual = date('Y-m-d');
                            echo $fechaActual;
                            ?>">
                            <input type="date" hidden value="<?php $fechaFin = date('Y-m-d');
                            echo $fechaFin;?>" class="form-control" required name="rxsal">
                            ...
                            <input type="text" name="mddoc" value="DNI" hidden>
                        </div>
                        <button class="reply-btn" type="submit" name="md_insert" ><span>Mandar Mensaje</span></button>
    ...
    <footer class="footer-area">
                    ...
                    <div class="col-lg-6 col-md-6 pt-4 pt-lg-0">
                        <div class="single-widget">
                            ...
                            <p>
                                ...
                                <br>
                                <a style="color:gray;" href="tel:+528180789607">+52 81 8078 9607</a>
                            </p>
        ...
        <div class="footer-bottom text-center">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <p>Copyright © <a href="politicas.html">Politicas de privacidad.</a> Todos los derechos reservados por <a href="politicas.html">Engranet.</a></p>
                    </div>
                </div>
            </div>
        </div>
